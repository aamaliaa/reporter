...
var Reporter = function() {
	...
	this._extractAnswer = function(obj) {
		if(typeof obj !== 'undefined') {
			...
			} else if(obj.hasOwnProperty('textResponse')) {
				return obj['textResponse'];
			} else if(obj.hasOwnProperty('numericResponse')) {
				return obj['numericResponse'];
...
Reporter.prototype.getQuestions = function() {
	var that = this;
